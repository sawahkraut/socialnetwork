...
(function() {
        ...
        for (var j = 0; j < numOfFlowers; j++) {
            ...
            for (var i = 0; i < 5; i++) {
                ...
                petal.graphics
                    ...
                    .drawRoundRectComplex(0, 0, petalW, petalH, 12, 1, 12, 1);
            ...
            pistile.graphics
                .beginFill(pistileColor)
                .drawEllipse(-pistileW / 2, -pistileH / 2, pistileW, pistileH);
    ...
    function initLeaves() {
        for (var i = 0; i < numOfLeaves; i++) {
            ...
            var min = 12;
            var falltime =
                Math.round(window.innerHeight * 7) + Math.random() * 5000;

            leaf.graphics
                .beginFill(leafColorDark)
